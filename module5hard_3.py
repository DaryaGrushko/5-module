            ...
            for user in self.users:
                ...
                if nickname in user['nickname']:
                    ...
                    if user['password'] != hash(password):
                        ...
                        self.current_user = {'nickname': nickname, 'password': password, 'age': user['age']}
        ...
        for ar in args:
            ...
            if self.videos!=[]:
                ...
                if flag !=1: # Нашелся фильм с таким именем
                    self.videos.append({'title': ar.title, 'duration': ar.duration, 'time_now': ar.time_now, 'adult_mode': ar.adult_mode})
            ...
            if self.current_user['age'] < 18:
                ...
                for vid in self.videos:
                    if name_film in vid['title']:
                        ...
                        for sec in range(vid['duration']+1):
                            print (sec , end = ' ')
                            sec+=1
                            time.sleep(1)
